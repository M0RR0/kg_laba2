...
////Боковые грани призмы
	...
	glTexCoord2d(0, 0.3);
	glVertex3dv(A2);
	glTexCoord2d(0.35, 0.1);
	glVertex3dv(B2);
	glTexCoord2d(0.45, 0.4);
	glVertex3dv(C2);
	...
	glTexCoord2d(0.45, 0.5);
	glVertex3dv(G2);
	glTexCoord2d(0.65, 0.7);
	glVertex3dv(F2);
	glTexCoord2d(0.9, 0.5);
	glVertex3dv(E2);
...
void Render(OpenGL* ogl)
{
	...
	std::stringstream ss;
	ss << "A - вкл/выкл альфаналожения(off свет и текст)" << endl;
